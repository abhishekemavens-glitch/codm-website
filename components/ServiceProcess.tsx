...
export default function ServiceProcess({ data }: { data: ServiceProcessData }) {
  const steps = [
    { title: data.processStep1Title, description: data.processStep1Description },
    { title: data.processStep2Title, description: data.processStep2Description },
    { title: data.processStep3Title, description: data.processStep3Description },
    { title: data.processStep4Title, description: data.processStep4Description },
    ...
    <section className="codm-process-section-wrap">
      <div className="codm-process-inner">
        ...
        {data.processDescription && (
          <p className="codm-process-description">{data.processDescription}</p>
        )}
